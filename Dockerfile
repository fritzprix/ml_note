...
RUN pip install --upgrade scikit-learn matplotlib ipympl autopep8 jupyter_contrib_nbextensions jupyter-tabnine python_language_server transformers torchvision  d2l
